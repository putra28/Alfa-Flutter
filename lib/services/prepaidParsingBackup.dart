...
class ISOMessageParsing {
  ...
  static String parseISOResponse(String isoMessage, String idpel) {
    ...
    String? bit62; // Deklarasi untuk menyimpan Bit 62
    ...
    // Proses Bit 39
    if (bit39 != null) {
      return processResponseCode(bit39, idpel, bit48, bit62);
    } else {
  ...
  static List<dynamic> parseBit62(String bit62) {
    ...
    return [
      ...
      kodeUnit, // KODE UNIT
      telpUnit, // TELP UNIT
      totalUnsoldVal, // TOTAL UNSOLD
      dataPerulanganVal, // DATA PERULANGAN
    ];
  }

  static String processResponseCode(
      String bit39, String idpel, String? bit48, String? bit62) {
    if (bit39 == '00') {
