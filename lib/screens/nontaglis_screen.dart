...
class _nontaglis_screenState extends State<nontaglis_screen> {
      ...
      child: Shimmer.fromColors(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            _buildShimmerRow("NOMOR REGISTRASI"),
            _buildShimmerRow("JENIS TRANSAKSI"),
            _buildShimmerRow("NAMA"),
            _buildShimmerRow("RP. BAYAR"),
            _buildShimmerRow("ADMIN BANK"),
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      final isoMessagetoSent = "XX" + processor.createIsoMessage(_controller.text, productCode);
      ...
      //     final parsingISO = await processorParsing.printResponse(serverResponse, _controller.text);
      ...
      //       _showError('Terjadi Kesalahan', serverResponseClean);
      //       _controller.clear();
      //     } else {
      //       setState(() {
  ...
  Future<void> _handleBooking() async {
    try {
      ...
      int? totalAdmin = prefs.getInt('admin');
